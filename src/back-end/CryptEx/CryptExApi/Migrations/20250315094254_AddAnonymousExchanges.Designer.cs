...
namespace CryptExApi.Migrations
{
    ...
    [Migration("20250315094254_AddAnonymousExchanges")]
    partial class AddAnonymousExchanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptExApi.Models.Database.AnonymousExchange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CryptExApi.Models.Database.AnonymousExchange", b =>
                {
                    b.HasOne("CryptExApi.Models.Database.Wallet", "DestinationWallet")
                        .WithMany()
                        .HasForeignKey("DestinationWalletId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CryptExApi.Models.Database.Wallet", "SourceWallet")
                        .WithMany()
